...
// Called when no matching intent is found
...
/*
 * The following block handles intents and slots for the questioning what your risk of having corona is.
 * It handles all the different states.
 *
 * Build after the following graphic https://interactive.zeit.de/2020/flussdiagramme/static/media/breit@2x.de5a4dd6.png
 */
...
/*
 * Below is the handler that returns random activities
 */
var TASKS = [
...
const LangweiligHandler = {
    ...
    handle(handlerInput) {
        var factIndex = Math.floor(Math.random() * TASKS.length);
        var randomFact = TASKS[factIndex];
...
exports.handler = skillBuilder
    .addRequestHandlers(
        ...
        CompletedHohesRisiko,
        CompletedMittleresRisiko,
        CompletedKeinRisiko,
